...
local function createGui()
    ...
    main.Visible = not isTouchDevice
    ...
    closeButton.BackgroundColor3 = Color3.fromRGB(42, 48, 60)
    closeButton.Text = "Ã—"
    ...
    local function setMenuVisible(visible)
        ...
        toggleButton.Text = visible and "Close" or "Menu"
    end
    ...
    toggleButton.Size = UDim2.new(0, 96, 0, 38)
    toggleButton.Position = UDim2.new(1, -110, 1, -52)
    ...
    if isTouchDevice then
        ...
        toggleButton.Position = UDim2.new(0.5, -55, 1, -56)
        toggleButton.Text = "Menu"
    end
